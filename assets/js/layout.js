        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10">
            ...
            <div class="space-y-4">
                ...
                <ul class="space-y-2.5 text-xs font-bold">
                    ...
                    <li><a href="${basePath}index.html#representatives" class="hover:text-sky-400 transition-colors flex items-center gap-2"><i class="fa-solid fa-location-dot text-[10px] text-indigo-400"></i>مندوب المنطقة الشرقية</a></li>
                    <li><a href="${basePath}index.html#representatives" class="hover:text-sky-400 transition-colors flex items-center gap-2"><i class="fa-solid fa-location-dot text-[10px] text-purple-400"></i>مندوب المنطقة الجنوبية</a></li>
